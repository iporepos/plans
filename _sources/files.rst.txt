...
#. :ref:`io-intermediate-files`: data files generated by ``plans`` as intermediate step to final processing. Users may also provide this files to skip intermediate steps. Like input files, intermediate files lives in the ``data/`` folder of a project;
